      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className={`max-w-2xl transition-all duration-1000 ${
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#mentor"
              className="inline-flex items-center justify-center px-8 py-4 bg-white/95 text-lg font-medium rounded-md text-blue-600 hover:bg-white transition-all duration-200 transform hover:scale-105"
            >
              Become a Mentor
